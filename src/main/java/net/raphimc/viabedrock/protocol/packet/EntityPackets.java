...
public class EntityPackets {
    ...
    public static void register(final BedrockProtocol protocol) {
        protocol.registerClientbound(ClientboundBedrockPackets.ADD_ENTITY, ClientboundPackets26_3.ADD_ENTITY, wrapper -> {
            ...
            int spawnData = 0;
            if (entity.javaType() == EntityTypes26_3.FALLING_BLOCK) {
    ...
    public static boolean isRideable(final Entity entity) {
        final EntityTypes26_3 type = entity.javaType();
        return type.isOrHasParent(EntityTypes26_3.ABSTRACT_BOAT)
                || type.isOrHasParent(EntityTypes26_3.ABSTRACT_HORSE)
                || type.isOrHasParent(EntityTypes26_3.ABSTRACT_MINECART)
                || type == EntityTypes26_3.CAMEL
                || type == EntityTypes26_3.CAMEL_HUSK
                || type == EntityTypes26_3.STRIDER
                || type == EntityTypes26_3.PIG
                || type == EntityTypes26_3.HAPPY_GHAST;
    }
