...
public class HudPackets {
    ...
    public static void register(final BedrockProtocol protocol) {
        ...
        protocol.registerClientbound(ClientboundBedrockPackets.TOAST_REQUEST, ClientboundPackets26_3.SET_ACTION_BAR_TEXT, wrapper -> {
        ...
        protocol.registerClientbound(ClientboundBedrockPackets.SHOW_CREDITS, ClientboundPackets26_3.GAME_EVENT, wrapper -> {
