        ...
        switch (id) {
            case RESERVED_0, RESERVED_092 -> { // Entity flags mask
                ...
                if (entity.javaType().isOrHasParent(EntityTypes26_3.LIVING_ENTITY)) {
                    ...
                    javaEntityData.add(new EntityData(entity.getJavaEntityDataIndex(EntityDataFields.POSE), VersionedTypes.V26_3.entityDataTypes().poseType, pose));
                    ...
                    if (!sleeping || bedPosition != null) {
                        javaEntityData.add(new EntityData(entity.getJavaEntityDataIndex(EntityDataFields.SLEEPING_POS), VersionedTypes.V26_3.entityDataTypes().optionalBlockPositionType, bedPosition));
                    }
                }
            ...
            case NAME -> {
                ...
                if (entityData.getValue() instanceof String name && entity.javaType().isOrHasParent(EntityTypes26_3.LIVING_ENTITY)) {
                    javaEntityData.add(new EntityData(entity.getJavaEntityDataIndex(EntityDataFields.CUSTOM_NAME), VersionedTypes.V26_3.entityDataTypes().optionalComponentType, name.isEmpty() ? null : TextUtil.textComponentToNbt(TextUtil.stringToTextComponent(name))));
                }
            }
            case BED_POSITION -> {
                if (entity.entityFlags().contains(ActorFlags.SLEEPING) && entity.javaType().isOrHasParent(EntityTypes26_3.LIVING_ENTITY) && entityData.getValue() instanceof com.viaversion.viaversion.api.minecraft.BlockPosition position) {
                    javaEntityData.add(new EntityData(entity.getJavaEntityDataIndex(EntityDataFields.SLEEPING_POS), VersionedTypes.V26_3.entityDataTypes().optionalBlockPositionType, position));
                }
            }
            case NAMETAG_ALWAYS_SHOW -> {
                ...
                javaEntityData.add(new EntityData(entity.getJavaEntityDataIndex(EntityDataFields.CUSTOM_NAME_VISIBLE), VersionedTypes.V26_3.entityDataTypes().booleanType, readNumber(entityData).intValue() != 0));
            }
            case HURT -> {
                ...
                if (entity.javaType().isOrHasParent(EntityTypes26_3.LIVING_ENTITY)) {
                    ...
                    javaEntityData.add(new EntityData(entity.getJavaEntityDataIndex(EntityDataFields.HURT), VersionedTypes.V26_3.entityDataTypes().varIntType, hurtTicks));
                }
            }
            case HURT_DIR -> {
                if (entity.javaType().isOrHasParent(EntityTypes26_3.LIVING_ENTITY)) {
                    javaEntityData.add(new EntityData(entity.getJavaEntityDataIndex(EntityDataFields.HURTDIR), VersionedTypes.V26_3.entityDataTypes().floatType, readNumber(entityData).floatValue()));
                }
            }
            case EFFECT_COLOR -> {
                if (entity.javaType().isOrHasParent(EntityTypes26_3.LIVING_ENTITY)) {
                    javaEntityData.add(new EntityData(entity.getJavaEntityDataIndex(EntityDataFields.EFFECT_COLOR), VersionedTypes.V26_3.entityDataTypes().varIntType, readNumber(entityData).intValue()));
                }
            }
            case USING_ITEM -> {
                if (entity.javaType().isOrHasParent(EntityTypes26_3.LIVING_ENTITY)) {
                    javaEntityData.add(new EntityData(entity.getJavaEntityDataIndex(EntityDataFields.USING_ITEM), VersionedTypes.V26_3.entityDataTypes().booleanType, readNumber(entityData).intValue() != 0));
                }
            }
